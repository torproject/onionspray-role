...
onionspray_project_settings:
  - project_name: "example2"
    ...
    hardmaps:
      ...
      - proxied_domain: example.null

      # Onion Service mapping to example.tld
      # Certificates are generated and self-signed by Onionspray
      - tor_address: expeksycd6djb4bvyan7vpl7rqb6rfecz4kkluj66gw6fd6wopc2pxyd.onion
        proxied_domain: example.tld
      ...
      - tor_address: exmp3cho5nxislcjefyovvsqd36g23ouofdjtiiypv4cs3ahhpyonxyd
        proxied_domain: example.io
  ...
  - project_name: "example1"
    ...
    softmaps:
      ...
      - proxied_domain: example.com
        tor_address: excomw23fzloy3lekgrayzsiina4lqztjka5bvgqqe35xbfgcfrmjpyd.onion
    foreingmaps:
